...
|---|---|---|
| **LLM** | Hugging Face Router (`Qwen/Qwen2.5-7B-Instruct`) | Best-in-class instruction following; reliable citation behaviour; unified API |
...
| `DEFAULT_MODEL_LLM` | `Qwen/Qwen2.5-7B-Instruct` | Model for responses |
