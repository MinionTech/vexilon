...
13.24
(1) If a movable work platform on wheels is not designed for or intended to be moved along the floor or other supporting surface while a person is occupying the platform, the platform must be secured to prevent that movement before a person accesses or occupies the platform.
